...
for i, b in enumerate(bin_labels):
    ...
    ax[0].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=sf_colors[i], alpha=0.25)
    ...
    ax[0].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=gv_colors[i], alpha=0.25)
ax[0].set_ylim(-5, -1)
"""
if gals == 'all':
    ax[0].set_xlim(0, 3.5)
...
for i, b in enumerate(bin_labels):
    ...
    ax[3].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=sf_colors[i], alpha=0.25)
    ...
    ax[3].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=gv_colors[i], alpha=0.25)
...
for i, b in enumerate(bin_labels):
    ...
    ax[4].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=sf_colors[i], alpha=0.25)
    ...
    ax[4].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=gv_colors[i], alpha=0.25)
...
for i, b in enumerate(bin_labels):
    ...
    ax[5].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=sf_colors[i], alpha=0.25)
    ...
    ax[5].fill_between(rplot, tukey - cv_err, tukey + cv_err, color=gv_colors[i], alpha=0.25)
ax[5].set_ylim(-3, )

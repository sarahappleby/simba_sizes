...
for w, wind in enumerate(winds):
	...
	if rotate_galaxies:
		profile_dir += '/rotated_faceon'
	else:
		profile_dir += '/random_orientation'
	if bh_center:
		profile_dir += '/bh_centered/'
	else:
		profile_dir += '/scom_centered/'
...
plt.clf()
for w in range(len(winds)):
	plt.errorbar(bins+(dr*0.5), sm_mean[w], yerr=sm_sigma[w], marker='.', markersize=4, linestyle='--', 
				label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
plt.yscale('log')
plt.legend()
plt.xlabel('R half *')
plt.ylabel('M* surface density (Msun/kpc^2)')
...
for w in range(len(winds)):
	plt.plot(bins+(dr*0.5), star_sfr_median[w], marker='.', markersize=4, linestyle='--', label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
	plt.fill_between(bins+(dr*0.5), star_sfr_lower[w], star_sfr_higher[w], alpha=0.3)
plt.legend()
plt.xlabel('R half *')
...
plt.clf()
for w in range(len(winds)):
	plt.errorbar(bins+(dr*0.5), star_sfr_mean[w], yerr=star_sfr_sigma[w], marker='.', markersize=4, linestyle='--', 
				label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
plt.legend()
plt.xlabel('R half *')
plt.ylabel('SFR surface density (Msun/yr /kpc^2)')
...
for w in range(len(winds)):
	plt.plot(bins+(dr*0.5), np.log10(star_ssfr_median[w]), marker='.', markersize=4, linestyle='--', label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
	plt.fill_between(bins+(dr*0.5), np.log10(star_ssfr_lower[w]), np.log10(star_ssfr_higher[w]), alpha=0.3)
plt.legend()
plt.xlabel('R half *')
...
plt.clf()
for w in range(len(winds)):
	plt.errorbar(bins+(dr*0.5), np.log10(star_ssfr_mean[w]), yerr=star_ssfr_sigma[w], marker='.', markersize=4, linestyle='--', 
				label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
plt.legend()
plt.xlabel('R half *')
plt.ylabel('log sSFR (yr^-1)')
...
for w in range(len(winds)):
	plt.plot(bins+(dr*0.5), gas_sfr_median[w], marker='.', markersize=4, linestyle='--', label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
	plt.fill_between(bins+(dr*0.5), gas_sfr_lower[w], gas_sfr_higher[w], alpha=0.3)
plt.legend()
plt.xlabel('R half *')
plt.ylabel('SFR surface density (Msun/yr /kpc^2)')
plt.xlim(0, 2)
...
plt.clf()
for w in range(len(winds)):
	plt.errorbar(bins+(dr*0.5), gas_sfr_mean[w], yerr=gas_sfr_sigma[w], marker='.', markersize=4, linestyle='--', 
				label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
plt.legend()
plt.xlabel('R half *')
plt.ylabel('SFR surface density (Msun/yr /kpc^2)')
...
for w in range(len(winds)):
	plt.plot(bins+(dr*0.5), np.log10(gas_ssfr_median[w]), marker='.', markersize=4, linestyle='--', label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
	plt.fill_between(bins+(dr*0.5), np.log10(gas_ssfr_lower[w]), np.log10(gas_ssfr_higher[w]), alpha=0.3)
plt.legend()
plt.xlabel('R half *')
plt.ylabel('log sSFR (yr^-1)')
plt.xlim(0, 2)
...
plt.clf()
for w in range(len(winds)):
	plt.errorbar(bins+(dr*0.5), np.log10(gas_ssfr_mean[w]), yerr=gas_ssfr_sigma[w], marker='.', markersize=4, linestyle='--', 
				label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
plt.legend()
plt.xlabel('R half *')
plt.ylabel('log sSFR (yr^-1)')
...
for w in range(len(winds)):
	plt.plot(bins+(dr*0.5), gas_h1_median[w], marker='.', markersize=4, linestyle='--', label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
	plt.fill_between(bins+(dr*0.5), gas_h1_lower[w], gas_h1_higher[w], alpha=0.3)
plt.legend()
plt.xlabel('R half *')
...
plt.clf()
for w in range(len(winds)):
	plt.errorbar(bins+(dr*0.5), gas_h1_mean[w], yerr=gas_h1_sigma[w], marker='.', markersize=4, linestyle='--', 
				label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
plt.legend()
plt.xlabel('R half *')
plt.ylabel('HI surface density (Msun /kpc^2)')
...
for w in range(len(winds)):
	plt.plot(bins+(dr*0.5), gas_h2_median[w], marker='.', markersize=4, linestyle='--', label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
	plt.fill_between(bins+(dr*0.5), gas_h2_lower[w], gas_h2_higher[w], alpha=0.3)
plt.legend()
plt.xlabel('R half *')
...
plt.clf()
for w in range(len(winds)):
	plt.errorbar(bins+(dr*0.5), gas_h2_mean[w], yerr=gas_h2_sigma[w], marker='.', markersize=4, linestyle='--', 
				label=wind_labels[w] +', '+str(no_gals[w])+' galaxies')
plt.legend()
plt.xlabel('R half *')
plt.ylabel('HII surface density (Msun /kpc^2)')

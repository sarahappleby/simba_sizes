...
plt.semilogy(rplot, sm_median, marker='.', markersize=4, linestyle='--')
plt.fill_between(rplot, sm_lower, sm_higher, alpha=0.3)
plt.xlabel('R half *')
plt.ylabel('M* surface density (Msun/R half bin^2)')
plt.xlim(0, 2)
plt.savefig(results_dir+'sm_medians.png')
plt.clf()
plt.errorbar(rplot, sm_mean, yerr=sm_sigma, marker='.', markersize=4, linestyle='--')
plt.yscale('log')
plt.xlabel('R half *')
plt.ylabel('M* surface density (Msun/R half bin^2)')
plt.xlim(0, 2)
...
plt.plot(rplot, star_sfr_median, marker='.', markersize=4, linestyle='--')
plt.fill_between(rplot, star_sfr_lower, star_sfr_higher, alpha=0.3)
plt.xlabel('R half *')
plt.ylabel('SFR surface density (Msun/yr /R half bin^2)')
plt.xlim(0, 2)
plt.savefig(results_dir+'star_sfr_medians.png')
plt.clf()
plt.errorbar(rplot, star_sfr_mean, yerr=star_sfr_sigma, marker='.', markersize=4, linestyle='--')
plt.xlabel('R half *')
plt.ylabel('SFR surface density (Msun/yr /R half bin^2)')
plt.xlim(0, 2)
...
plt.plot(rplot, np.log10(star_ssfr_median), marker='.', markersize=4, linestyle='--')
plt.fill_between(rplot, np.log10(star_ssfr_lower), np.log10(star_ssfr_higher), alpha=0.3)
plt.xlabel('R half *')
...
plt.clf()
plt.errorbar(rplot, np.log10(star_ssfr_mean), yerr=star_ssfr_sigma, marker='.', markersize=4, linestyle='--')
plt.xlabel('R half *')
plt.ylabel('log sSFR (yr^-1)')
plt.xlim(0, 2)
plt.ylim(-13, )
...
plt.plot(rplot, gas_sfr_median, marker='.', markersize=4, linestyle='--')
plt.fill_between(rplot, gas_sfr_lower, gas_sfr_higher, alpha=0.3)
plt.xlabel('R half *')
plt.ylabel('SFR surface density (Msun/yr /R half bin^2)')
plt.xlim(0, 2)
plt.ylim(0, )
...
plt.clf()
plt.errorbar(rplot, gas_sfr_mean, yerr=gas_sfr_sigma, marker='.', markersize=4, linestyle='--')
plt.xlabel('R half *')
plt.ylabel('SFR surface density (Msun/yr /R half bin^2)')
plt.xlim(0, 2)
plt.ylim(0, )
...
plt.plot(rplot, np.log10(gas_ssfr_median), marker='.', markersize=4, linestyle='--')
plt.fill_between(rplot, np.log10(gas_ssfr_lower), np.log10(gas_ssfr_higher), alpha=0.3)
plt.xlabel('R half *')
plt.ylabel('log sSFR (yr^-1)')
plt.xlim(0, 2)
plt.ylim(-13, )
...
plt.clf()
plt.errorbar(rplot, np.log10(gas_ssfr_mean), yerr=gas_ssfr_sigma, marker='.', markersize=4, linestyle='--')
plt.xlabel('R half *')
plt.ylabel('log sSFR (yr^-1)')
plt.xlim(0, 2)
plt.ylim(-13, )
...
plt.plot(rplot, gas_h1_median, marker='.', markersize=4, linestyle='--')
plt.fill_between(rplot, gas_h1_lower, gas_h1_higher, alpha=0.3)
plt.xlabel('R half *')
...
plt.clf()
plt.errorbar(rplot, gas_h1_mean, yerr=gas_h1_sigma, marker='.', markersize=4, linestyle='--')
plt.xlabel('R half *')
plt.ylabel('HI surface density (Msun /R half bin^2)')
plt.xlim(0, 2)
plt.ylim(0, )
...
plt.plot(rplot, gas_h2_median, marker='.', markersize=4, linestyle='--')
plt.fill_between(rplot, gas_h2_lower, gas_h2_higher, alpha=0.3)
plt.xlabel('R half *')
...
plt.clf()
plt.errorbar(rplot, gas_h2_mean, yerr=gas_h2_sigma, marker='.', markersize=4, linestyle='--')
plt.xlabel('R half *')
plt.ylabel('HII surface density (Msun /R half bin^2)')
plt.xlim(0, 2)
plt.ylim(0, )
